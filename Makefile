# This Makefile is for the DateTime::BusinessHours extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/DateTime/BusinessHours.pm]
#     AUTHOR => [q[Antano Solar <solar345@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[DateTime::BusinessHours]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/DateTime/BusinessHours.pm]
#     clean => { FILES=>q[DateTime-BusinessHours-*] }
...
NAME_SYM = DateTime_BusinessHours
VERSION = 1.01
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/bricas/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/bricas/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.62
MM_REVISION = 66200
...
MAKE = make
FULLEXT = DateTime/BusinessHours
BASEEXT = BusinessHours
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/DateTime/BusinessHours.pm
...
TO_INST_PM = lib/DateTime/BusinessHours.pm

PM_TO_BLIB = lib/DateTime/BusinessHours.pm \
...
DISTVNAME = DateTime-BusinessHours-1.01
...
manifypods : pure_all  \
	lib/DateTime/BusinessHours.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/DateTime/BusinessHours.pm $(INST_MAN3DIR)/DateTime::BusinessHours.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Antano Solar <solar345@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: DateTime-BusinessHours' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Antano Solar <solar345@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "DateTime-BusinessHours",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Antano Solar &lt;solar345@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/DateTime/BusinessHours.pm blib/lib/DateTime/BusinessHours.pm 
